...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { list_id: @list_item.list_id, part_id: @list_item.part_id } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { list_id: @list_item.list_id, part_id: @list_item.part_id } }
